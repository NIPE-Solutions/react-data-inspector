...
| 13. Editing                  | [Immutable design](api.md#editing-design); intentionally deferred implementation                          |
...
| 26. Documentation site       | [Website](../website/App.tsx), locally runnable and production-buildable                                  |
| 27. Customization playground | Seven working scenarios plus safe JSON/predefined-JS playground                                           |
...
| 31. Naming                   | Verified NIPE conventions, existing private repo and unpublished npm candidate                            |
