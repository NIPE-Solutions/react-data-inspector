...
export const legalPages = [
  {
    ...
    title: 'Imprint',
    description:
      'Legal information, service provider and media owner for React Data Inspector by NIPE Solutions.',
  },
  {
    path: '/privacy',
    title: 'Privacy',
    description:
      'Privacy information for the React Data Inspector website: controller, hosting, no tracking and your rights.',
  },
] as const
    ...
    <>
      ...
      <section>
        ...
        <p>
          ...
          non-essential cookies. It uses system fonts, so visiting a page does
          not request fonts from an external font provider.
        </p>
      </section>
...
export function Legal({ kind }: LegalPageProps) {
  return (
    <>
      <Header />
